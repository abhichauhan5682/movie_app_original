...
var FormItem = /*#__PURE__*/function (_React$Component) {
  ...
  function FormItem() {
    ...
    _this.renderFormItem = function (_ref) {
      ...
      return React.createElement(_antd.Row, Object.assign({
  ...
  _createClass(FormItem, [{
    ...
    value: function renderValidateWrapper(prefixCls, c1, c2, c3) {
      ...
      switch (validateStatus) {
        case 'success':
          iconType = React.createElement(_icons.CheckCircleFilled, null);
          break;

        case 'warning':
          iconType = React.createElement(_icons.ExclamationCircleFilled, null);
          break;

        case 'error':
          iconType = React.createElement(_icons.CloseCircleFilled, null);
          break;

        case 'validating':
          iconType = React.createElement(_icons.LoadingOutlined, null);
          break;
    ...
    value: function renderWrapper(prefixCls, children) {
      ...
      return React.createElement(_context.default.Consumer, {
        ...
        }, React.createElement(_antd.Col, Object.assign({}, mergedWrapperCol, {
          className: className
        }), children));
      });
    }
    ...
    value: function renderLabel(prefixCls) {
      ...
      return React.createElement(_context.default.Consumer, {
        ...
        return label ? React.createElement(_antd.Col, Object.assign({}, mergedLabelCol, {
    ...
    value: function render() {
      return React.createElement(_CompatibleConsumer.default, null, this.renderFormItem);
    }
  }]);
